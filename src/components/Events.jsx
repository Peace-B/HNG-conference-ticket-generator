...
const Events = () => {
  ...
  // 🔥 Clears localStorage and state on refresh
  useEffect(() => {
  ...
  return (
    <div className='bg-gradient-to-b from-[#041E23] to-[#07373F] py-2'>
      ...
      <div className="w-[350px] h-[1220px] px-0 bg-gradient-to-b from-[#04262c] to-[#041E23] xl:w-[700px] xl:h-[800px] m-auto mt-6 border-1 border-[#0E464F] rounded-3xl xl:px-12 pt-8">
        <div className="bar">
          <div className="w-[280px] flex xl:flex-row justify-between xl:items-center xl:w-[580px] m-auto text-white">
            <h1 className="text-xl xl:text-3xl">Ticket Selection</h1>
            <p>Step 1/3</p>
          </div>
          <ProgressBar progress={35} />
          <div className="w-[300px] bg-[#041E23] border-0 xl:w-[600px] h-[675px] xl:bg-[#08252B] xl:border-1 border-[#0E464F] m-auto mt-4 rounded-3xl flex flex-col text-white">
            ...
            <div className="w-[300px] h-[270px] pb-6 xl:w-[550px] xl:pb-0 xl:h-[160px] border-1 border-[#0E464F] m-auto rounded-3xl mt-5 text-center bg-gradient-to-l from-[#08252BF] to-[#07373F] mb-0">
              ...
              <p className="pb-8 w-[250px] xl:w-[300px] m-auto xl:pb-0">
                Join us for an unforgettable experience at <span>{purchase ? "tech event " : "[Event Name]"}</span>! Secure your spot now.
              </p>
                ...
                <div 
                  ...
                  className={`border-3 rounded-xl text-md h-[120px] p-3 mt-1 cursor-pointer xl:border border-[#0E464F] 
                    ...
                    onClick={() => {
                      ...
                      localStorage.setItem("selectedTicket", ticket.type);  // ✅ Save ticket type
                    }}
            ...
            <div className="w-[300px] mt-8 xl:w-[550px] m-auto">
              ...
              <input 
                ...
                onChange={(e) => {
                  ...
                  localStorage.setItem("ticketCount", e.target.value);  // ✅ Save ticket count
                }}
            ...
            <div className="w-[300px] bg-[#041E23] xl:w-[550px] m-auto mt-8 xl:border border-[#197686] rounded-xl xl:flex justify-evenly">
              <button 
                className="px-31 mb-4 xl:mb-0 text-[#0E464F] border border-[#0E464F] xl:px-25 py-2 rounded-xl"
                onClick={() => {
                  setSelectedTicket('');
                  setTicketCount('');
                }}
